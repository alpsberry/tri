...
int BasicSolvingSystem::fileOutputTriplet(Mesh mesh, MyProblem prob)
{
...
int BasicSolvingSystem::fileOutputRH(Mesh mesh, MyProblem prob)
{
...
int BasicSolvingSystem::fileOutputMA(Mesh mesh, MyProblem prob)
{
